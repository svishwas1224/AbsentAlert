...
export default function LecturerDashboard() {
  ...
  const [requests, setRequests] = useState([])   // student requests
  ...
  return (
    <div className="dash-layout">
      ...
      <main className="main">
        ...
        {page === 'requests' && (
          <div className="fade-in">
            ...
            <div className="card">
              <div className="table-wrap">
                <table>
                  <thead><tr><th>Student</th><th>Class</th><th>Type</th><th>From</th><th>To</th><th>Days</th><th>Reason</th><th>Status</th><th>Actions</th></tr></thead>
                  <tbody>
                    {requests.map(l => (
                      <tr key={l.id}>
                        <td className="td-primary">{l.applicant_name}</td>
        ...
        {page === 'my-leaves' && (
          <div className="fade-in">
            <div className="topbar"><div className="topbar-left"><h1>My Leave History</h1><p>Your submitted leave applications</p></div></div>
            <div className="card">
              <div className="table-wrap">
                <table>
          ...
          <div className="fade-in">
            ...
            <div className="card">
              <div style={{display:'flex',alignItems:'center',gap:'1.25rem',marginBottom:'1.5rem',paddingBottom:'1.5rem',borderBottom:'1px solid var(--border)'}}>
                <div className="avatar-lg avatar-faculty">{user?.lecturer_name?.split(' ').map(w=>w[0]).join('').toUpperCase().slice(0,2)}</div>
                <div>
        ...
        <div className="modal-overlay" onClick={e=>e.target===e.currentTarget&&setModal(null)}>
          <div className="modal">
            <div className="modal-header">
              <h3>{modalAction==='approve'?'Approve Leave':modalAction==='reject'?'Reject Leave':'Forward to Management'}</h3>
